...
var dg = {
  ...
  showEl: function(id, options) {
    if (this.el(id)) this.el(id).style.display = (options && options.inline)? "inline-block":"block";
  },  
  hideEl: function(id, options) {
